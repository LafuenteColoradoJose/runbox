...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content>
      <form [formGroup]="invForm" class="dialog-form">
        <mat-form-field appearance="fill">
          ...
          @if (invForm.get('name')?.hasError('required')) {
        ...
        <mat-form-field appearance="fill">
          ...
          @if (invForm.get('organization_id')?.hasError('required')) {
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-flat-button color="primary" [disabled]="invForm.invalid" (click)="save()">
        Save
      </button>
    </mat-dialog-actions>
  `,
