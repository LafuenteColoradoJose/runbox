...
- **Backend:** Node.js, Express, Better-SQLite3, Vitest (Testing), Integración nativa con Git (`simple-git`), Soporte de categorización (Tags en JSON).
- **Frontend:** Angular 22 (Todo a Signals), Material Design, ECharts (Topología y Dashboard de métricas), Búsqueda Reactiva y Filtrado por Categorías en Tiempo Real, Vitest (Testing).
